...
class _PaymentPageState extends State<PaymentPage> {
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                        color: Color(0xFFFF6F00).withOpacity(0.2),
                        blurRadius: 8,
                        offset: Offset(0, 4))
                  ],
                ),
              ...
              SizedBox(height: 15),
              _buildPaymentMethodCard("bKash", "📱 bKash Mobile Wallet",
                  Color(0xFFFF6F00), selectedMethod == "bKash"),
              SizedBox(height: 12),
              _buildPaymentMethodCard("Nagad", "💳 Nagad Mobile Banking",
                  Color(0xFF7C3AED), selectedMethod == "Nagad"),
              SizedBox(height: 30),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                            ...
                            style: TextStyle(
                                color: txt, fontWeight: FontWeight.w600)),
                      ],
                    ),
                    SizedBox(height: 10),
                    Row(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                            _amountController.text.isEmpty
                                ? "৳ 10"
                                : "৳ ${(int.tryParse(_amountController.text) ?? 0) + 10}",
                            style: TextStyle(
  ...
  Widget _buildPaymentMethodCard(
      String method, String title, Color color, bool isSelected) {
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected
              ...
              : (widget.isDark ? Color(0xFF2A2A2A) : Color(0xFFF5F5F5)),
          border: Border.all(
  ...
  Map<String, dynamic> _checkNewBadgesAndGetInfo() {
    ...
    // Silver badge
        ...
        !unlockedBadges.contains("silver")) {
      unlockedBadges.add("silver");
      badgeInfo = {
        "found": true,
        "name": "Silver Badge",
        "emoji": "🥈",
        "reward": "🎁 ৳100 Discount Voucher"
      };
    }
    // Gold badge
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            style: ElevatedButton.styleFrom(backgroundColor: Color(0xFF2ECC71)),
            onPressed: () async {
              // 1. Get the amount from controller
              int amt = int.tryParse(_amountController.text) ?? 0;

              // 2. Try to save to database (optional - won't block payment if fails)
              try {
                await Supabase.instance.client.from('payments').insert({
                  'amount': amt,
                  'description':
                      'Payment via $selectedMethod from ${_phoneController.text}',
                  'status': 'completed',
                });
              } catch (dbError) {
                // Database save failed - log but continue with payment
                print('Database save failed (optional): $dbError');
              }

              // 3. Keep your existing local logic (always runs)
              ...
              // Second pop to go back to the dashboard
              Navigator.pop(context);
            },
